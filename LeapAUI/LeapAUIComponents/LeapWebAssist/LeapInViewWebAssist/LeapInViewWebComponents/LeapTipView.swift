...
class LeapTipView: LeapInViewWebAssist {
    ...
    override init(withDict assistDict: Dictionary<String, Any>, iconDict: Dictionary<String, Any>? = nil, toView: UIView, baseUrl: String?, projectParametersInfo: [String : Any]? = nil) {
        super.init(withDict: assistDict, iconDict: iconDict, toView: toView, baseUrl: baseUrl, projectParametersInfo: projectParametersInfo)
