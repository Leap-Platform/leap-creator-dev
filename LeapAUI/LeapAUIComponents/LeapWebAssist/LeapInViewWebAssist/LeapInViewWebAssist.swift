...
class LeapInViewWebAssist: LeapWebAssist {
    ...
    init(withDict assistDict: Dictionary<String, Any>, iconDict: Dictionary<String, Any>? = nil, toView: UIView, baseUrl: String?, projectParametersInfo: [String : Any]? = nil) {
        ...
        self.projectParameters = LeapProjectParameters(withDict: projectParametersInfo ?? [:])
