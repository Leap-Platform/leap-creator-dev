...
class LeapJSMaker {
    ...
    class func calculateBoundsScript(_ id:LeapWebIdentifier) -> String {
    ...
    class func generateNullCheckScript(identifier:LeapWebIdentifier) -> String {
        let elementScript = generateBasicElementScript(id: identifier)
        return "(" + elementScript + " != null).toString()"
    }

    class func generateAttributeCheckScript(webIdentifier:LeapWebIdentifier) -> String? {
    ...
    class func generateBasicElementScript(id:LeapWebIdentifier) -> String {
